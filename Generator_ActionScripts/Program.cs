...
namespace Generator_ActionScripts
{
    class Program
    {
        public static string g_Path_BlackDesert64Dump = @"E:\BDO Dumped Clients\912\BlackDesert64_dump.exe";

        public static string g_PazFileRoot = @"D:\BDO_PazGameData\Unpacked";
